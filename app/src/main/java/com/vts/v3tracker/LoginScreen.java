...
import com.vts.v3tracker.util.SystemUiHider;
...
public class LoginScreen extends Activity {
	...
	private static final String  EXTRA_MESSAGE = "FROM_LOGIN";
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	...
            	if(resp.status == HttpStatus.SC_OK) {
            		...
            		Log.v("LoginScree", "Login failure");
            	}
            }
        });
	}
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		// are available.
		delayedHide(10); //FIXME : make this configurable or based on h/w feedback
	}
